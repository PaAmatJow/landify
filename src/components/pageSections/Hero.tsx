...
const Hero = () => {
	return (
		<div className='bg-light min-h-[calc(100vh-80px)] w-full relative top-[80px]'>
			<div className='relative min-h-[calc(100vh-80px)] max-w-[1366px] mx-auto bg-light'>
				{/* mobile hero */}
				...
				<div className='absolute left-[74%] top-[20px] hidden h-[calc(100vh-100px)] w-[1000px] items-center bg-[#1B1A20] md:flex'>
				...
				<div className='flex h-[calc(100vh-100px)] flex-col justify-center px-[20px] lg:px-[80px]'>
					<div className='relative flex w-full flex-col gap-[20px] pl-[40px] md:w-[60%]'>
						<h1 className='text-[48px] font-extrabold leading-[44px] sm:text-[60px] sm:leading-[56px] md:text-[66px] md:leading-[70px] lg:text-[70px] 2xl:text-[85px]'>
							Academy <br /> of Your Business
						</h1>
						<p className='mb-[10px] max-w-[90%] text-[18px] text-gray-500 lg:text-[18.5px] 2xl:text-[20px]'>
