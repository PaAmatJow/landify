export const SERVICES = [
	{
		...
		desc : `We've designed and built eccomerce experiences that have driven sales.`,
    variant: 'bg-sun'
	},
	{
		id : 2,
	...
	},
	{
		...
		desc : 'Strategic Business Leader is a training course from the Strategc Professional level.',
    variant: 'bg-Pink'
	},
	{
		id : 4,
	...
	{ id : 5, title : 'Business English Writing Skills', desc : 'A unique opportunity to gain guidance and feedback from our expert.',
  variant: 'bg-sun' },
	{ id : 6, title : 'Strategic Business Reporting', desc : 'Strategic Business Reporting is a Professional level training course. It covers topics related to advanced financial reporting, including leasing.',
  variant: 'bg-lime' },
];
